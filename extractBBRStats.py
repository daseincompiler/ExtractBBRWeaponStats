...
categories = {
    "Assault Rifles": ["AK47", "M4A1", "AK15", "SCARH", "AUG_A3", "SG550", "FAMAS", "ACR", "G36C", "HK419", "FAL", "AK5C"],

    "Submachine Guns": ["MP7", "UMP45", "PP2000", "PP19", "KrissVector", "MP5"],

    "Personal Defense Weapons": ["HoneyBadger", "Groza", "P90"],

    "Carbines": ["AS_VAL", "ScorpionEvo"],

    "Light Machine Guns": ["L86A1", "M249", "MG36"]
}
